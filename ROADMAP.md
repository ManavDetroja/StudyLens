...
- Source adapters for video URLs, PDF files, image/OCR, and text.
- Content normalisation and chunking.
...
Only the Day 2 UI foundation is implemented now. The V2 and V3 items are plans, not active features.
